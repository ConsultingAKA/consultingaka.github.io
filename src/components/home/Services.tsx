      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
              <span className="gradient-text">Our Expert Services</span>
            </h2>
            <p className="text-xl text-secondary-600 dark:text-secondary-400">
              Comprehensive consulting solutions to drive your AI initiatives forward
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
          {services.map((service, index) => (
            <motion.div
              key={index}
              className="bg-secondary-50 dark:bg-secondary-900 rounded-xl p-8 border border-secondary-100 dark:border-secondary-800 shadow-soft hover:shadow-medium transition-all duration-300"
